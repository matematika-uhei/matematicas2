...
<!-- APC customizations for producing the main book -->
...
<xsl:import href="./apc-common.xsl" />
...
<xsl:param name="latex.geometry" select="'centering,text={16cm,24cm},a4paper,showframe=false '" />
